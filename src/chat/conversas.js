                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={style.boxContatos}>
                                        ...
                                        <View style={{ flexDirection: 'column' }}>
                                            ...
                                            <Text style={{ fontSize: 13, marginLeft: 20,color:'#abb59f' }}>{item.mensagem}</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            </View>
...
const mapStateToProps = state => ({
    conversas: state.ChatReducer.conversas
})

export default connect(mapStateToProps,null)(Conversas);